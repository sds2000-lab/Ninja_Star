...
// 👉 Добавляем экран Ашдода
import 'package:fluttermvvmtemplate/view/birthday/birthday_packages_ashdod_view.dart';
...
class NavigationRoute {
  ...
  Route<dynamic> generateRoute(RouteSettings args) {
    ...
    // -------------------------
    // 🔹 НОВЫЕ ЭКРАНЫ ПРОЕКТА
    // -------------------------

      case NavigationConstants.BIRTHDAY_PACKAGES_ASHDOD:
        return normalNavigate(
          const BirthdayPackagesAshdodView(),
          NavigationConstants.BIRTHDAY_PACKAGES_ASHDOD,
        );
