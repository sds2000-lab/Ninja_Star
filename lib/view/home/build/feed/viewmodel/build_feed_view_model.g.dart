...
mixin _$BuildFeedViewModel on _BuildFeedViewModelBase, Store {
  ...
  @override
  HouseModel get sliderHouse => (_$sliderHouseComputed ??= Computed<HouseModel>(
    () => super.sliderHouse,
    name: '_BuildFeedViewModelBase.sliderHouse',
  )).value;

  late final _$likeItemsAtom = Atom(
    name: '_BuildFeedViewModelBase.likeItems',
    context: context,
  );
  ...
  late final _$houseModelsAtom = Atom(
    name: '_BuildFeedViewModelBase.houseModels',
    context: context,
  );
  ...
  late final _$isLoaindgAtom = Atom(
    name: '_BuildFeedViewModelBase.isLoaindg',
    context: context,
  );
  ...
  late final _$_BuildFeedViewModelBaseActionController = ActionController(
    name: '_BuildFeedViewModelBase',
    context: context,
  );
