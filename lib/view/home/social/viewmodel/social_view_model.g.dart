...
mixin _$SocialViewModel on _SocialViewModelBase, Store {
  late final _$socialUserListAtom = Atom(
    name: '_SocialViewModelBase.socialUserList',
    context: context,
  );
  ...
  late final _$isPageLoadingAtom = Atom(
    name: '_SocialViewModelBase.isPageLoading',
    context: context,
  );
  ...
  late final _$isPageLoadingLazyLoadAtom = Atom(
    name: '_SocialViewModelBase.isPageLoadingLazyLoad',
    context: context,
  );
  ...
  set isPageLoadingLazyLoad(bool value) {
    _$isPageLoadingLazyLoadAtom.reportWrite(
      value,
      super.isPageLoadingLazyLoad,
      () {
  ...
  late final _$_fetchAllUserAsyncAction = AsyncAction(
    '_SocialViewModelBase._fetchAllUser',
    context: context,
  );
  ...
  late final _$fetchAllUserLoadingAsyncAction = AsyncAction(
    '_SocialViewModelBase.fetchAllUserLoading',
    context: context,
  );

  @override
  Future<void> fetchAllUserLoading(int index) {
    return _$fetchAllUserLoadingAsyncAction.run(
      () => super.fetchAllUserLoading(index),
    );
  }

  late final _$_SocialViewModelBaseActionController = ActionController(
    name: '_SocialViewModelBase',
    context: context,
  );
