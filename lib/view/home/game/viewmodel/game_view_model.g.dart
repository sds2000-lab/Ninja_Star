...
mixin _$GameViewModel on _GameViewModelBase, Store {
  late final _$isLoadingAtom = Atom(
    name: '_GameViewModelBase.isLoading',
    context: context,
  );
  ...
  late final _$fetchSliderItemsAsyncAction = AsyncAction(
    '_GameViewModelBase.fetchSliderItems',
    context: context,
  );
  ...
  late final _$_GameViewModelBaseActionController = ActionController(
    name: '_GameViewModelBase',
    context: context,
  );
