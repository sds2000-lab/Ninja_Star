...
mixin _$BurgerViewModel on _BurgerViewModelBase, Store {
  late final _$isLoadingAtom = Atom(
    name: '_BurgerViewModelBase.isLoading',
    context: context,
  );
  ...
  late final _$isLoadingMainAtom = Atom(
    name: '_BurgerViewModelBase.isLoadingMain',
    context: context,
  );
  ...
  late final _$favoriteBurgerModelAtom = Atom(
    name: '_BurgerViewModelBase.favoriteBurgerModel',
    context: context,
  );
  ...
  late final _$mainBurgerModelAtom = Atom(
    name: '_BurgerViewModelBase.mainBurgerModel',
    context: context,
  );
  ...
  late final _$fetchFavoriteAsyncAction = AsyncAction(
    '_BurgerViewModelBase.fetchFavorite',
    context: context,
  );
  ...
  late final _$fetchNormalItemsAsyncAction = AsyncAction(
    '_BurgerViewModelBase.fetchNormalItems',
    context: context,
  );
  ...
  late final _$fetchMinMaxAsyncAction = AsyncAction(
    '_BurgerViewModelBase.fetchMinMax',
    context: context,
  );
  ...
  late final _$_BurgerViewModelBaseActionController = ActionController(
    name: '_BurgerViewModelBase',
    context: context,
  );
