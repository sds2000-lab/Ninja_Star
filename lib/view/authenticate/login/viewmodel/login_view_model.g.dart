...
mixin _$LoginViewModel on _LoginViewModelBase, Store {
  ...
  late final _$isLockOpenAtom = Atom(
    name: '_LoginViewModelBase.isLockOpen',
    context: context,
  );
  ...
  late final _$fetchLoginServiceAsyncAction = AsyncAction(
    '_LoginViewModelBase.fetchLoginService',
    context: context,
  );
