...
mixin _$SplashViewModel on _SplashViewModelBase, Store {
  late final _$isFirstInitAtom = Atom(
    name: '_SplashViewModelBase.isFirstInit',
    context: context,
  );
  ...
  late final _$_SplashViewModelBaseActionController = ActionController(
    name: '_SplashViewModelBase',
    context: context,
  );
